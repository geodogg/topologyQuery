...
ifeq ($(TARGET_ARCH),armv7l)
  $(info >>> WARNING - topologyQuery is not supported on ARMv7 - waiving sample <<<)
  SAMPLE_ENABLED := 0
endif

# This sample is not supported on aarch64
ifeq ($(TARGET_ARCH),aarch64)
  $(info >>> WARNING - topologyQuery is not supported on aarch64 - waiving sample <<<)
  SAMPLE_ENABLED := 0
endif
...
topologyQuery.o:topologyQuery.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

topologyQuery: topologyQuery.o
...
clean:
	rm -f topologyQuery topologyQuery.o
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/topologyQuery
